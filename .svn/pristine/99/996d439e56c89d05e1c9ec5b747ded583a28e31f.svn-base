...
public class PhoneOnlineListener implements HttpSessionListener,
		HttpSessionAttributeListener {
	private static int currentSessionCount = 0;

	private static int maxSessionCount = 0;
	
	private static String preKeyRedisList="sso.userList.phone";
	...
	public PhoneOnlineListener() {
		System.out.println("phoneOnlineListerner Constructor...");
	}
	...
	public void attributeAdded(HttpSessionBindingEvent se) {
		if ("loginedPhone".equals(se.getName())) {
			// synchronized(list)
...
//			logined.add(om);
	...
	public static OnlineModel getSession(String sessionId) {
		if (sessionId == null) {
			return null;
		}
		synchronized (lock) {
